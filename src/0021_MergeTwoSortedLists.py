...
def test_merge_two_lists():
    assert Solution().mergeTwoLists(
        to_linked_list([1, 2, 4]), to_linked_list([1, 3, 4])
    ) == to_linked_list([1, 1, 2, 3, 4, 4])
    assert Solution().mergeTwoLists(
        to_linked_list([1, 2, 4]), to_linked_list([])
    ) == to_linked_list([1, 2, 4])
    assert Solution().mergeTwoLists(
        to_linked_list([]), to_linked_list([1, 3, 4])
    ) == to_linked_list([1, 3, 4])
    assert Solution().mergeTwoLists(
        to_linked_list([]), to_linked_list([])
    ) == to_linked_list([])
    assert Solution().mergeTwoLists(
        to_linked_list([1, 2, 4]), to_linked_list([1, 3, 4, 5])
    ) == to_linked_list([1, 1, 2, 3, 4, 4, 5])
